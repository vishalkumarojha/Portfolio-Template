export default function Hero() {
  return (
    <section className="text-center py-20">
      ...
      <h1 className="text-5xl font-bold text-gray-900 mb-2">Your Name</h1>
      <p className="text-xl text-gray-600 mb-6">NLP, LLM Reasoning, Mechanistic Interpretability and CUDA</p>
